...
// TEMPORARILY DISABLED for crash-loop diagnosis — see conversation history.
...
function buildServer() {
  ...
  const allTools = toolDefinitions; // transcript test tool temporarily removed for diagnosis
